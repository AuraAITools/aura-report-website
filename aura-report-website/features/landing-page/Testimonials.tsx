...
const TestimonialsColumn = (props: {
  ...
  return (
    <div className={props.className}>
      ...
      >
        {/* Have to duplicate the testimonials to achieve the animations */}
        {[
    ...
    <section className='bg-white '>
      <div className='section-heading'>
        ...
        <p className='section-description mt-5'>
          From intuitive design to powerul features , our app has become an
          essential tool for users aournd the world
        </p>
      </div>
      <div className='flex justify-center gap-6 mt-10 mx-4 [mask-image:linear-gradient(to_bottom,transparent,black_25%,black_75%,transparent)] max-h-[738px] overflow-hidden'>
